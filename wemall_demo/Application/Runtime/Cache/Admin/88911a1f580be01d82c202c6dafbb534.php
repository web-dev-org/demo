											...
											<tbody>
												<tr>
													...
													<td><select name="pid" class="normal_select">
															...
															<?php if(is_array($menuFir)): $i = 0; $__LIST__ = $menuFir;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select></td>
												</tr>
												<tr>
													<td>显示名称:</td>
