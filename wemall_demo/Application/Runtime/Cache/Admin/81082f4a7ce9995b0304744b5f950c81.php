		...
		<div class="widget-header">
			<div class="widget-toolbar no-border">
				<ul class="nav nav-tabs" id="myTab">
					<li><a data-toggle="tab" href="#home1">商品价格管理</a></li>
				</ul>
			</div>
		</div>
					...
					<div id="home1" class="tab-pane in active">
						<form class="form-horizontal J_ajaxForm" enctype="multipart/form-data" id="priceform" method="post">
								...
								<div class="col-xs-12 no-padding-right">
									<div class="table-responsive">
									   <div style="margin-bottom:10px" >
											...
											<input type="hidden" name="dataNum" value="<?php echo ($count); ?>" />
										</div>										
										<table id="sample-table-1"
											...
											<tbody>
											<?php if(is_array($priceList)): $k = 0; $__LIST__ = $priceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
													<td class="center">
													...
													<td><input type="text" style="width:60px" id="percent_<?php echo ($k); ?>" name="percent_<?php echo ($k); ?>" value="<?php echo ($vo["percent"]); ?>" onblur="changePercent(this, <?php echo ($k); ?>, <?php echo ($vo["percent"]); ?>)"></td>
													<td><input type="text" style="width:60px" id="bprice_<?php echo ($k); ?>" name="bprice_<?php echo ($k); ?>" value="<?php echo ($vo["bprice"]); ?>" onblur="changePrice(this, <?php echo ($k); ?>, <?php echo ($vo["bprice"]); ?>)"></td>
													<td><?php echo ($vo["vprice"]); ?></td>
													<td><?php echo ($vo["nprice"]); ?></td>
													<td><?php echo ($vo["amt"]); ?></td>
													<td style="display:none"><input type="hidden" name="unitid_<?php echo ($k); ?>" value="<?php echo ($vo["id"]); ?>" /></td>
							...
							<div class="form-actions">
								<button class="btn btn-primary btn_submit J_ajax_submit_btn" onclick="submitPrice('1',<?php echo ($page); ?>)">保存</button>
							</div>
						</form>
					</div>
				</div>
