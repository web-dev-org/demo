...
<div class="main-container" id="main-container">
	...
	<ul class="nav nav-list">
		<li class="active">
			<a href="">
				<i class="icon-home"></i>
				<span class="menu-text"> 后台欢迎页 </span>
			</a>
		</li>
		<?php if($set == '1'): ?><li onclick="clickset('set')">
		...
		<?php if($menu == '1'): ?><li  onclick="clickset('menu')">
				<a href="javascript:void(0)">
					<i class="icon-list"></i>
		...
		<?php if($cityPercent == '1'): ?><li  onclick="clickset('citypercent')">
				<a href="javascript:void(0)">
					...
					<span class="menu-text"> 地域百分比管理 </span>
				</a>
			</li><?php endif; ?>
		...
		<?php if($confirm == '1'): ?><li onclick="clickset('confirm')">
				<a href="javascript:void(0)">
					<i class="icon-tint"></i>
		...
		<?php if($order == '1'): ?><li onclick="clickset('order')">
				<a href="javascript:void(0)">
		...
		<?php if($member == '1'): ?><li onclick="clickset('mem')">
				<a href="javascript:void(0)">
		...
		<?php if($salesCode == '1'): ?><li onclick="clickset('salesCode')">
				<a href="javascript:void(0)">
					...
					<span class="menu-text"> 邀请码管理 </span>
				</a>
			</li><?php endif; ?>
		<?php if($user == '1'): ?><li onclick="clickset('user')">
				<a href="javascript:void(0)">
					<i class="icon-key"></i>
					<span class="menu-text"> 账户管理 </span>
				</a>
			</li><?php endif; ?>
		<?php if($weixin == '1'): ?><li onclick="clickset('weixin')">
				<a href="javascript:void(0)">
					<i class="icon-edit"></i>
					<span class="menu-text"> 微信管理 </span>
				</a>
			</li><?php endif; ?>
		<?php if($countSale == '1'): ?><li onclick="clickset('countSales')">
				<a href="javascript:void(0)">
					<i class="icon-edit"></i>
					<span class="menu-text"> 业务统计 </span>
				</a>
			</li><?php endif; ?>
	</ul><!-- /.nav-list -->
...
<script type="text/javascript">
		...
		function clickset(name) {
			...
			/* 分类管理 */
			if ( name == "menu" ){
				$('#breadcrumbs ul li').eq(1).html('分类管理');
			...
			/* 地域百分比管理 */
			if ( name == "citypercent" ){
				$('#breadcrumbs ul li').eq(1).html('地域百分比管理');
			...
			/* 价格管理 */
			if ( name == "price" ){
				$('#breadcrumbs ul li').eq(1).html('价格管理');
			...
			/* 活动管理 */
			if ( name == "active" ){
				$('#breadcrumbs ul li').eq(1).html('活动管理');
			...
			/* 账户管理 */
			if ( name == "salesCode" ){
				$('#breadcrumbs ul li').eq(1).html('邀请码管理');
				$('#main_iframe').attr("src","<?php echo U('Admin/SalesCode/index');?>");
			}
			/* 数据统计 */
			if ( name == "count" ){
				$('#breadcrumbs ul li').eq(1).html('数据统计');
