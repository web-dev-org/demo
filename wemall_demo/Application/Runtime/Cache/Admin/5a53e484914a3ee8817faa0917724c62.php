...
$(function(){
	$("select").change(function() {
		var pid = $(this).find("option:checked").attr("id");
		if (pid == "0") {
			$('input[name="tax"]').attr("disabled",true );
			$('input[name="rule"]').attr("disabled",true);
			$('select[name="states"]').attr("disabled",true);
		}else{
								...
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<?php if(is_array($city)): $k = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$city): $mod = ($k % 2 );++$k;?><tr>
												...
												<td class="hidden-480"><?php echo ($city["tax"]); ?></td>
												<td class="hidden-480"><?php echo ($city["rule"]); ?></td>
												<td class="hidden-480"><?php echo ($city["statesname"]); ?></td>
												<td>
										...
										<table cellpadding="2" cellspacing="2" width="100%">
											<tbody>
												...
												<tr>
													<td>地域运费:</td>
													<td> 
														<input type="text" class="input" disabled="disabled" name="tax" value="" style="font-size:13px">
													</td>
												</tr>
												<tr>
													<td width="140">减免规则:</td>
													<td>
														<input type="text" class="input" disabled="disabled" name="rule" value="" style="font-size:13px">
														满多少金额减免运费，不填则视为不减免
													</td>
												</tr>
												<tr>
													...
													<td>
														<select name="states" class="normal_select" disabled="disabled">
